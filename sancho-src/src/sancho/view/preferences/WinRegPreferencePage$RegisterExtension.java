...
class WinRegPreferencePage$RegisterExtension {
   ...
   public WinRegPreferencePage$RegisterExtension(String var1, Composite var2) {
      this.text = var1;
      this.selection = 0;
   ...
   private void createButton(Group var1, String var2, int var3) {
      ...
      var4.addSelectionListener(new WinRegPreferencePage$4(this, var3));
   }
   ...
   // $VF: synthetic method
   static int access$402(WinRegPreferencePage$RegisterExtension var0, int var1) {
