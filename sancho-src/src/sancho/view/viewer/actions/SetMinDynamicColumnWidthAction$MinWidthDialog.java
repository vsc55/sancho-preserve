...
class SetMinDynamicColumnWidthAction$MinWidthDialog extends Dialog {
   int initialValue;
   int intValue;
   String title;
   BSpinner spinner;

   public SetMinDynamicColumnWidthAction$MinWidthDialog(Shell var1, String var2, int var3) {
      super(var1);
   ...
   protected Control createDialogArea(Composite var1) {
      ...
      var3.addSelectionListener(new SetMinDynamicColumnWidthAction$1(this, var3));
      return var2;
   }
